...
export function findPosition(height, weight, speed) {
  if (
    ...
    return "From what you have entered it sounds like you should be in the front row, these are the power houses of the team. You need to be strong in the neck and shoulders as they are essential in the scrum.";
  } else if (height >= 198 && weight > 245 && speed === "very slow") {
    return "If you are very tall you are typically expected to be a lock they push the front row and are the jumpers in the lineout.They are extremely powerful players and are essential to build a powerful team";
  } else if (
    height >= 179 &&
    height <= 192 &&
    ...
    return "By far the quickest people on the pitch and on the edges of the pitch, a quick burst of speed and quick feet can make wingers the match winners. Don't close them down and they will score.";
  } else {
    return "So lets get you on the pitch to really get an idea, you could be a speed front row or even .";
  }
}
